    ...
    <div className="w-full h-[80%] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red to-pink-500 px-6 py-8 text-center">
          ...
          <div className="px-6 py-8">
            ...
            <div className="space-y-3">
              {showRetry && (
                <button
                  onClick={handleTry}
                  className="w-full bg-gradient-to-r from-red to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
              ...
              <div className="flex gap-3">
                ...
                {showGoHome && (
                  <button
                    ...
                    } bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2`}
                  >
